...
(define (print es esint co fin);inicio de la definición de la función print, la cual se encarga de imprimir las letras Z en las posiciones adecuadas desde el inicio-1 hasta el final
...
(define (printu es esint co fin);inicio de la definición de la función printu, la cual se encarga de imprimir la letra Z de la última primera en la posición adecuada
  (printf "~aZ" (make-string (+ es 1) #\space))
  (newline)
  (set! co (+ co 1))
  (contador es esint co fin)
);fin de la definición de la función

(define es 9);es = variable empleada para definir en ella la cantidad de espacios externos a la figura que es necesario imprimir en el respectivo ciclo
(define esint 1);esint = variable empleada para definir en ella el la cantidad de espacios internos de la figura que es necesario imprimir en el respectivo ciclo
