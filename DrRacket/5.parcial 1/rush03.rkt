...
(define (esq ini_1 fin_1 ini fin);inicio de la definición de la función esq quien valida en cuál de las dos filas de extremo se encuentra el ciclo actual
  (if (= ini 1)
      (bsgin3 ini_1 fin_1)
      (printf "")
  )
...
(define (bsgin3 ini_1 fin_1);inicio de la definición de la función bsgin3 quien valida en qué esquina se encuentra el ciclo actual e imprime el caracter que correspone
  (if (= ini_1 1)
      (printf "A")
      (printf "")
  )
  (if (and (= ini_1 fin_1) (> fin_1 1))
      (printf "C")
      (printf "")
  )
);fin de la definición de la función
(define (bsgin4 ini_1 fin_1);inicio de la definición de la función bsgin4 quien valida en qué esquina se encuentra el ciclo actual e imprime el caracter que correspone
  (if (= ini_1 1)
      (printf "A")
      (printf "")
  )
